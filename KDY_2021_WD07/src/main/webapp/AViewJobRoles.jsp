			...
			<div class="row">
				...
				<div class="col-sm-9 padding-right">
					<div class="features_items"><!--features_items-->
						<h2 class="title1 text-center">AVAILABLE JOB ROLES</h2>
					</div>	
				</div>
				
				<h4 class="title text-center">Click on the button to view all the roles roles</h4>
				...
				<div class="col-sm-4 col-sm-offset-1">
					<div class="login-form"><!--login form-->
						<h2>Click here!!!</h2>
						<form action="ViewJobRolesServlet" method="post">
						
							 <button type="submit" name="check" class="btn btn-default"> Job Roles </button>
