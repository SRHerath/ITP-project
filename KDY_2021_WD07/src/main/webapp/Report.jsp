...
<!-- The above 3 meta tags *must* come first in the head; any other head content must come *after* these tags -->
	...
	<title>Monthly Sales Report | Textile</title>
		...
		<div class="booking-form">
			<div class="form-header">
				...
				<br/><br/>
									...
									while(resultSet.next())
									{%>
									<table id="contentBoxDemoBlueTable">
										<tr><td id="contentBoxDemoBlueTD"><span><b>
											
											<h4>Return Percentage(relative to order) = <%=percn=resultSet.getFloat("(sum(jayasadha.ordercontain.returnCount)/sum(jayasadha.ordercontain.quantity))*100") %>%</b></h4>
										</span></td></tr></table>
									...
									<table id="contentBoxDemoBlueTable">
										<tr><td id="contentBoxDemoBlueTD"><span><b>
											...
											<h4>Total Item Price = Rs.<%=resultSet.getInt("sum(item.ItemPrice)") %>.00</b></h4>
										</span></td></tr></table>
									...
									{%>	
									<table id="contentBoxDemoBlueTable">
										<tr><td id="contentBoxDemoDarkTD"><span><b>
											
											<h4>Total Sales = Rs.<%=resultSet.getInt("sum((ordercontain.quantity-ordercontain.returnCount)*item.ItemPrice)") %>.00</b></h4>
										</span></td></tr></table>
