...
<head>
    ...
    <title>Inquiry Management | Jayasadha</title>
...
<body>
	...
	<section id="advertisement">
		<div class="container">
		<h1 class="title text-center">Welcome to Inquiry Management</h1> 
		</div>
	</section>
									...
									<h4 class="panel-title">
										<a data-toggle="collapse" data-parent="#accordian" href="">
											...
											<form action="edit"  method ="post"> 
                                                  <input type="submit" class="inqu_btn" name="Validate" value="SHOW INQUIRY">
                                              </form>
										</a>
									</h4>
								</div>							
