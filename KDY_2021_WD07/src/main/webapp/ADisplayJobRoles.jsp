...
<head>
   ...
   <title>Employee Management | Jayasadha</title>
    ...
    <link href="css/TableCSS/AEmployeeCSS.css" rel="stylesheet">
    <!--[if lt IE 9]>
			...
			<div class="row">
				<div class="col-md-5">
					...
					<div class="table-wrap">
					   ...
					   <c:forEach var="com" items="${viewJobs}">
        
				        <c:set var="pID" value="${com.getPositionId()}"/>
				        <c:set var="Jdescription" value="${com.getJobDescription()}"/>
				        <c:set var="Bsalary" value="${com.getBasicSalary()}"/>
				        
					      <tr>
					        <th scope="row" class="scope" >${com.getPositionId()}</th>
					            <td>${com.getJobDescription()}</td>
					            <td>${com.getBasicSalary()}</td>
