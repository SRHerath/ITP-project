<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    pageEncoding="ISO-8859-1" import = "java.util.ArrayList, com.jayasadha.shoppingcart_orderhandling.Shop"%>
<!DOCTYPE html>
<html>
<head>
		...
		<div class="header-bottom"><!--header-bottom-->
			<div class="container">
				<div class="row">
					<div class="col-sm-9">
						...
						<div class="mainmenu pull-left">
							<ul class="nav navbar-nav collapse navbar-collapse">
								<li><a href="cart_viewItems">Home</a></li>
					...
					<form action="cart_viewItems" class="searchform">
			...
			<div class="row">
					...
					<div class="left-sidebar">
						...
						<div class="panel-group category-products" id="accordian"><!--category-productsr-->
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title">
										<a data-toggle="collapse" data-parent="#accordian" href="Men.jsp">
											<span class="badge pull-right"><i ></i></span>
											Men
										</a>
									</h4>
							...
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title">
										<a data-toggle="collapse" data-parent="#accordian" href="Women.jsp">
											<span class="badge pull-right"><i></i></span>
											Women
										</a>
									</h4>
				...
				<div class="col-sm-9 padding-right">
					<div class="features_items"><!--features_items-->
						...
						ArrayList<Shop> list =  (ArrayList<Shop>)session.getAttribute("cart_view_items");
						...
						for(Shop item : list){
							...
							//itemQuantitty = item.getItemQuantitty();
							//ItemBrand = item.getItemBrand();
							//ItmCategory = item.getItmCategory();
							//ItemDescription = item.getItemDescription();
							//ItemColour = item.getItemColour();
							...
							<div class="product-image-wrapper">
								<div class="single-products">
									<div class="productinfo text-center">
										<img src="images/shop/<%=itemImage%>" alt="" />
										<h2>Rs.<%=itemPrice%></h2>
										<p> <%=ItemName%></p>
										<a href="" class="btn btn-default add-to-cart"><i class="fa fa-star"></i>View Item</a>
										<a href="addToCart?IID=<%=ItemID%>" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
									</div>
